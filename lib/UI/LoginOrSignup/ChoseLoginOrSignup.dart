...
import 'package:shop_shop_flutter/UI/BottomNavigationBar.dart';
import 'package:shop_shop_flutter/UI/HomeUIComponent/Home.dart';
import 'package:shop_shop_flutter/UI/LoginOrSignup/Login.dart';
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Center(
                                /// Animation text Shop Ar accept from splashscreen layout (Click to open code)
                                child: Hero(
                                  tag: "Shop",
                                  child: Text(
                                    "Shop Ar",
                              ...
                              /// Padding Text "Get best product in Shop Ar" (Click to open code)
                              Padding(
                                  padding: EdgeInsets.only(
                                      left: 160.0,
                                      right: 160.0,
