import 'package:shop_shop_flutter/Library/carousel_pro/carousel_pro.dart';
import 'package:flutter/material.dart';
import 'package:shop_shop_flutter/ListItem/HomeGridItemRecomended.dart';
import 'package:shop_shop_flutter/UI/HomeUIComponent/AppbarGradient.dart';
import 'package:shop_shop_flutter/Library/countdown/countdown.dart';
import 'package:shop_shop_flutter/UI/HomeUIComponent/CategoryDetail.dart';
import 'package:shop_shop_flutter/UI/HomeUIComponent/DetailProduct.dart';
import 'package:shop_shop_flutter/UI/HomeUIComponent/FlashSale.dart';
import 'package:shop_shop_flutter/UI/HomeUIComponent/MenuDetail.dart';
import 'package:shop_shop_flutter/UI/HomeUIComponent/PromotionDetail.dart';
import 'package:shop_shop_flutter/ar/ar.dart';
...
class _MenuState extends State<Menu> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    var textBox = Container(
            ...
            child: Text(
              "Tap on the image in Recomended section to view the normal image of the product & double tap the image to view the image in AR view",
              style: TextStyle(
